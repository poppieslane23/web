  ...
  if (index === 2) {
    feedback.innerHTML = "✅ <b>Benar!</b> Membeku adalah perubahan wujud dari cair menjadi padat, contohnya air menjadi es.";
  ...
  window.location.href = "/pagesGames/game7.html";
});
